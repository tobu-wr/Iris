namespace Iris.NDS
{
    public sealed partial class NDS_System : Common.System
    {
        ...
        {
            CPU.CPU_Core.MemoryInterface cpuMemoryInterface = new(ReadMemory8, ReadMemory16, ReadMemory32, WriteMemory8, WriteMemory16, WriteMemory32);
            _cpu = new(CPU.CPU_Core.Model.ARM946ES, cpuMemoryInterface);
